...
// このクラスはメインダイアログです。
//
inline class MainDialog : public DialogBase
{
public:
	...
	MainDialog(CWnd* parent = nullptr)
		: DialogBase(IDD_MAIN_DIALOG, parent)
	{
	}
		...
		case IDC_TRANSCRIBE:
			{
				constexpr struct {
					...
					const int c_show_transcriber_config_dialog = 2;
				} c_command_id;
				...
				menu.AppendMenu(MF_STRING, c_command_id.c_show_transcriber_config_dialog, _T("文字起こしのコンフィグ"));
				...
				case c_command_id.c_show_transcriber_config_dialog:
					{
						TranscriberConfigDialog dialog;
